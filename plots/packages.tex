...
\newcommand{\addplotfunctionalregression}[7]{%
    ...
    \fi
    \expandafter\@addplotregression@table@to@gnu\expandafter{\pgfplotstable@table}{\pgfplotstable@xsrc}{\pgfplotstable@ysrc}{\pgfplotstable@gnu@table}{#3}%
    \addplot [#6] gnuplot [raw gnuplot] { % allows arbitrary gnuplot commands
        ...
        set print "\jobname-parameters.dat";  % Open a file to save the parameters
        print #4;                  % Write the parameters to file
    };
    \pgfplotstableread{\jobname-parameters.dat}\parameters % Open the file Gnuplot wrote
