...
\expandaftercmds{\def\striptrailinggenerated#1}{\detokenize{generated/}{#1}}
\expandaftercmds{\def\@stripleadinggenerated#1}{\detokenize{generated/}#2\relax}{%
  \ifstrempty{#1}{%
    \ifstrempty{#2}{%
    }{%
      \striptrailinggenerated#2%
    }%
  }{%
    \ifstrempty{#2}{%
      #1%
    }{%
      \expandaftercmds{#1}{\detokenize{generated/}}\striptrailinggenerated#2%
    }%
  }%
}
\def\stripleadinggenerated#1{\expandafter\@stripleadinggenerated\detokenize{#1generated/}\relax}
\makeatother

\usepgfplotslibrary{external}
\tikzexternalize
\def\currdirfilebase{\expandafter\currfiledir\currfilebase}
\def\currdirfilebasenogenerated{\ExpandNext{\stripleadinggenerated}{\currdirfilebase}}
\def\currdirfilebasedash{\ExpandNext{\replaceslashdash}{\currdirfilebasenogenerated}}
\ExpandNext{\message}{\ExpandNext{Cur File: }{\currdirfilebasedash}}
\tikzsetfigurename{\tikzexternalrealjob-\currdirfilebasedash-figure}
