...
\edef\@pgftognucolsepset@braces{\detokenize{{}}}
\def\@pgftognucolsepset@rev#1#2{#2#1}
\edef\@pgftognucolsepset@braces{\expandafter\@pgftognucolsepset@rev\@pgftognucolsepset@braces}
\newcommand{\pgftognucolsepset}[2]{%
    \edef\@pgftognucolsepset@value{\pgfkeysvalueof{#1}}%
    \expandafter\IfEqCase\expandafter{\@pgftognucolsepset@value}{%
        {space}    {\edef#2{whitespace}}%
        {tab}      {\edef#2{"\string\t"}}%
        {comma}    {\edef#2{","}}%
        {semicolon}{\edef#2{";"}}%
        {colon}    {\edef#2{":"}}%
        {braces}   {\edef#2{"\@pgftognucolsepset@braces"}}%
        {&}        {\edef#2{"&"}}%
        {ampersand}{\edef#2{"&"}}%
    }[%
        \edef#2{"\@pgftognucolsepset@value"}%
    ]%
}
\makeatletter
...
\NewDocumentCommand{\addplotexponentialregression}{ O{no markers} o m}{%
    ...
    \pgfkeyssetvalue{/addplotexponentialregression/col sep}{space}
    ...
    \pgftognucolsepset{/addplotexponentialregression/col sep}{\@addplotexponentialregression@colsep}%
    \addplot [#1] gnuplot [raw gnuplot] { % allows arbitrary gnuplot commands
        ...
        set datafile separator \@addplotexponentialregression@colsep;
        fit f(x) '#3' u \@addplotexponentialregression@colx:\@addplotexponentialregression@coly\space via a,b; % Select the file
        stats '#3' u \@addplotexponentialregression@colx:\@addplotexponentialregression@coly;
...
\NewDocumentCommand{\addplotquadraticregression}{ O{no markers} o m}{%
    ...
    \pgfkeyssetvalue{/addplotquadraticregression/col sep}{space}
    ...
    \pgftognucolsepset{/addplotquadraticregression/col sep}{\@addplotquadraticregression@colsep}%
    \addplot [#1] gnuplot [raw gnuplot] { % allows arbitrary gnuplot commands
        ...
        set datafile separator \@addplotquadraticregression@colsep;
        fit f(x) '#3' u \@addplotquadraticregression@colx:\@addplotquadraticregression@coly\space via a,b,c; % Select the file
        stats '#3' u \@addplotquadraticregression@colx:\@addplotquadraticregression@coly;
        plot [x=STATS_min_x:STATS_max_x][STATS_min_y:STATS_max_y] f(x);    % Specify the range to plot
        set print "#3-parameters.dat";  % Open a file to save the parameters
...
\NewDocumentCommand{\addplotcubicregression}{ O{no markers} o m}{%
    ...
    \pgfkeyssetvalue{/addplotcubicregression/col sep}{space}
    ...
    \pgftognucolsepset{/addplotcubicregression/col sep}{\@addplotcubicregression@colsep}%
    \addplot [#1] gnuplot [raw gnuplot] { % allows arbitrary gnuplot commands
        ...
        set datafile separator \@addplotcubicregression@colsep;
        fit f(x) '#3' u \@addplotcubicregression@colx:\@addplotcubicregression@coly\space via a,b,c,d; % Select the file
        stats '#3' u \@addplotcubicregression@colx:\@addplotcubicregression@coly;
        plot [x=STATS_min_x:STATS_max_x][STATS_min_y:STATS_max_y] f(x);    % Specify the range to plot
        set print "#3-parameters.dat";  % Open a file to save the parameters
...
\NewDocumentCommand{\addplotfactorialregression}{ O{no markers} o m}{%
    \pgfkeyssetvalue{/addplotfactorialregression/x}{0}
    \pgfkeyssetvalue{/addplotfactorialregression/y}{1}
    \pgfkeyssetvalue{/addplotfactorialregression/a}{1}
    \pgfkeyssetvalue{/addplotfactorialregression/col sep}{space}
    \pgfkeys{/addplotfactorialregression/.cd,#2}
    \pgftognucolumnset{/addplotfactorialregression/x}{\@addplotfactorialregression@colx}%
    \pgftognucolumnset{/addplotfactorialregression/y}{\@addplotfactorialregression@coly}%
    \edef\@addplotfactorialregression@inita{\pgfkeysvalueof{/addplotfactorialregression/a}}%
    \pgftognucolsepset{/addplotfactorialregression/col sep}{\@addplotfactorialregression@colsep}%
    \addplot [#1] gnuplot [raw gnuplot] { % allows arbitrary gnuplot commands
        f(x) = a*gamma(x+1);     % Define the function to fit
        % Set reasonable starting values here
        a=\@addplotfactorialregression@inita;
        set datafile separator \@addplotfactorialregression@colsep;
        fit f(x) '#3' u \@addplotfactorialregression@colx:\@addplotfactorialregression@coly\space via a; % Select the file
        stats '#3' u \@addplotfactorialregression@colx:\@addplotfactorialregression@coly;
        plot [x=STATS_min_x:STATS_max_x][STATS_min_y:STATS_max_y] f(x);    % Specify the range to plot
        set print "#3-parameters.dat";  % Open a file to save the parameters
